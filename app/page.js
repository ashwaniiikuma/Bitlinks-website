...
We deliver a reliable URL shortening solution that enables users to create, monitor, and manage links effectively with a clean interface.
          ...
          <div className="flex flex-col sm:flex-row gap-6 py-8 md:py-10">
            <Link href="/shorten">
              <button className="bg-purple-500 px-6 py-2 text-white cursor-pointer rounded-lg font-bold hover:bg-purple-600 transition">
                Try Now
              </button>
            </Link>
              ...
              <button className="bg-gray-50 flex gap-3 px-4 py-2 text-black border-2 cursor-pointer border-black rounded-lg font-bold hover:bg-gray-100 transition">
